...
class Getreservation extends Getrooms {
...
//                die();
//        echo '<pre>';
//        print_r(json_decode($_POST['The_Orange_House']));
...
//		$this->infoArray['hotel_id'] = 397487;
                $this->infoArray['hotel_id'] = $_POST['hotel_id'];
//              $this->infoArray['supplier_type'] = "E";
                
                $this->infoArray['rateKey'] = $_POST['rateKey'];
		$this->infoArray['roomTypeCode'] = $_POST['roomTypeCode'];
		$this->infoArray['rateCode'] = $_POST['rateCode'];
		$this->infoArray['chargeableRate'] = $_POST['chargeableRate'];
